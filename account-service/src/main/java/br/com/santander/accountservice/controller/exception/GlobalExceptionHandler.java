...
import static br.com.santander.accountservice.util.Constants.INVALID_CEP;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlerNegocioException(BadRequestException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handlerNegocioException(EntityNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handlerNegocioException(FeignException ex, WebRequest request) {
        ...
        Problem problem = getProblem(status.value(), INVALID_CEP, null);
